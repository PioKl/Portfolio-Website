    ...
    return (
        <div id="contact" className="contact-container">
            ...
            <form className="contact-form" action="" onSubmit={handleSendMessage}>
                ...
                <textarea data-aos="fade-right" className="contact-form__input contact-form__input--message" name="message" id="" placeholder="Wiadomość" required/* cols="30" rows="10" */></textarea>
